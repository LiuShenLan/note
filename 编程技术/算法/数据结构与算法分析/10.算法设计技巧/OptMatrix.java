 ...
 * The minimum number of multiplications if left in m[1][n].
 * Actual ordering if computed via another procedure using lastChange.
 * m and lastChange are indexed starting at 1, instead of 0.
 * Note: Entries below main diagonals of m and lastChange ate meaningless and uninitialized.
 */
