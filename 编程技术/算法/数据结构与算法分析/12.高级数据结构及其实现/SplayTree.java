public class SplayTree<AnyType extends Comparable<? super AnyType>> {
     ...
     * Not the most effective implementation (uses two passes), but has correct amortized(摊还) behavior.
    ...
    private BinaryNode<AnyType> splay(AnyType x, BinaryNode<AnyType> t) {
        ...
        nullNode.element = x;   // Guarantee(保证) a match
     ...
     * For VAL trees, this is a single rotation for case 4.
     */
    ...
    // Basic node stired in unbalanced binary search trees
