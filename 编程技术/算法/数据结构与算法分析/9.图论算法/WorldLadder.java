public class WorldLadder {
    // Runs the shortest path calculation from the adjacency, returns a List that contains the sequence of world
    // changes to get from first to second. Returns null if no sequence can be found for any reason.
    ...
    // After the shortest path calculation has run, computes the List that contains the sequence of world changes to
    // get from first to second. Returns null if there is no path.
